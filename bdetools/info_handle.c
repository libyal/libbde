...
int info_handle_set_external_key(
     ...
     libcerror_error_t **error )
{
	static char *function   = "info_handle_set_external_key";
	size_t string_length    = 0;
	uint32_t base16_variant = 0;
	...
	info_handle->external_key_is_set = 1;
     ...
     libcerror_error_t **error )
{
	...
	static char *function       = "info_handle_set_external_key_identifier";
	size_t string_length        = 0;
	...
	if( libfguid_identifier_copy_to_byte_stream(
	     guid,
	     info_handle->external_key_identifier,
	     16,
     ...
     libcerror_error_t **error )
{
	...
	if( info_handle->external_key_is_set != 0 )
	{
