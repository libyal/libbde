...
#if !defined( _BDETOOLS_GETOPT_H )
#define _BDETOOLS_GETOPT_H
...
typedef struct bdetools_option bdetools_option_t;

struct bdetools_option
{
...
#define bdetools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t bdetools_getopt(
                  int argument_count,
...
void bdetools_getopt_wrapped_fprint(
      FILE *stream,
...
void bdetools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const bdetools_option_t *options,
      int number_of_options );

int bdetools_getopt_get_options_string(
     const bdetools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _BDETOOLS_GETOPT_H ) */
