...
#if !defined( _LIBBDE_LIBCTHREADS_H )
#define _LIBBDE_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBBDE )
#define HAVE_LIBBDE_MULTI_THREAD_SUPPORT
#endif
