...
typedef struct bde_volume_header_used_space_only bde_volume_header_used_space_only_t;

struct bde_volume_header_used_space_only
{
	/* The boot entry point
	 * Consists of 3 bytes
	 */
	...
	/* Unknown
	 * Consists of 294 bytes
	 */
	uint8_t unknown5[ 294 ];
