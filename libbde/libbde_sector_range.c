...
{
	static char *function = "libbde_sector_range_initialize";
	...
	*sector_range = memory_allocate_structure(
	...
	if( memory_set(
	     *sector_range,
	     0,
	     sizeof( libbde_sector_range_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libbde_sector_range_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libbde_sector_range_free";
