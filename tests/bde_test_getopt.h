...
#if !defined( _BDE_TEST_GETOPT_H )
#define _BDE_TEST_GETOPT_H
...
#define bde_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t bde_test_getopt(
                  int argument_count,
...
#endif /* !defined( _BDE_TEST_GETOPT_H ) */
