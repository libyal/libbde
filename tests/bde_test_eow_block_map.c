/*
 * Library eow_block_map type test program
 *
...
#include "../libbde/libbde_eow_block_map.h"

uint8_t bde_test_eow_block_map_data1[ 512 ] = {
...
/* Tests the libbde_eow_block_map_initialize function
 * Returns 1 if successful or 0 if not
 */
int bde_test_eow_block_map_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libbde_eow_block_map_initialize(
	          &eow_block_map,
	          &error );
	...
	result = libbde_eow_block_map_free(
	          &eow_block_map,
	          &error );
	...
	eow_block_map = (libbde_eow_block_map_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libbde_eow_block_map_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libbde_eow_block_map_initialize with memset failing
		 */
...
/* Tests the libbde_eow_block_map_free function
 * Returns 1 if successful or 0 if not
 */
int bde_test_eow_block_map_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libbde_eow_block_map_read_data function
 * Returns 1 if successful or 0 if not
 */
int bde_test_eow_block_map_read_data(
     void )
{
	libbde_eow_block_map_t *eow_block_map = NULL;
	libcerror_error_t *error              = NULL;
	...
	/* Test regular cases
	 */
	result = libbde_eow_block_map_read_data(
	          eow_block_map,
	          bde_test_eow_block_map_data1,
	          512,
	          &error );
	...
	/* Test bde_test_eow_block_map_read_data with memcpy failing
	 */
	 ...
	 */
	bde_test_eow_block_map_data1[ 0 ] = 0xff;
	...
	bde_test_eow_block_map_data1[ 0 ] = 0x46;
...
/* Tests the libbde_eow_block_map_read_file_io_handle function
 * Returns 1 if successful or 0 if not
 */
int bde_test_eow_block_map_read_file_io_handle(
     void )
{
	libbde_eow_block_map_t *eow_block_map = NULL;
	...
	/* Test regular cases
	 */
	result = libbde_eow_block_map_read_file_io_handle(
	          eow_block_map,
	          file_io_handle,
	          0,
	          512,
...
#endif
{
	...
	BDE_TEST_RUN(
	 "libbde_eow_block_map_initialize",
	 bde_test_eow_block_map_initialize );

	BDE_TEST_RUN(
	 "libbde_eow_block_map_free",
	 bde_test_eow_block_map_free );

	BDE_TEST_RUN(
	 "libbde_eow_block_map_read_data",
	 bde_test_eow_block_map_read_data );

	BDE_TEST_RUN(
	 "libbde_eow_block_map_read_file_io_handle",
	 bde_test_eow_block_map_read_file_io_handle );
