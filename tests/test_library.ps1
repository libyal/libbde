...
$LibraryTests = "aes_ccm_encrypted_key error external_key io_handle key key_protector metadata metadata_block_header metadata_entry metadata_header notify password_keep sector_data stretch_key volume_master_key"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libbde"
